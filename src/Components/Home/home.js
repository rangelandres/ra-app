            ...
            <div className="social-media-container">
                <div className="social-media">
                    <div className="social-icon">
                        <a href="https://twitter.com/andresrangeI" target="_blank">
                    ...
                    <div className="social-icon" id="icon">
                        <a href="https://www.instagram.com/andresrangel.exe/" target="_blank">
                    ...
                    <div className="social-icon" id="icon">
                        <a href="https://www.linkedin.com/in/rangel-andres/" target="_blank">
